...
import top.swordsman.empire.procedures.MikuChestplateEventProcedure;
...
public abstract class MikuItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 99999, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_diamond")), () -> Ingredient.of(), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("empire:miku3939"))), 1024f, 5f);
			registerHelper.register(ResourceLocation.parse("empire:miku"), armorMaterial);
