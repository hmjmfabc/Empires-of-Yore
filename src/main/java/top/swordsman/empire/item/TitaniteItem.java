...
public abstract class TitaniteItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 28, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_netherite")), () -> Ingredient.of(new ItemStack(EmpiresOfYoreMod.TITANITE_INGOT.get())),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("empire:titanite"))), 4f, 0.3f);
			registerHelper.register(ResourceLocation.parse("empire:titanite"), armorMaterial);
