...
**剑客群组服（Swordsman Group Server, SGU）定制 Minecraft 模组**，基于 **NeoForge 21.1.248 / Minecraft 1.21.1**（Java 21）构建。
...
- 初音未来（Miku 3939）四件套护甲（穿戴即无敌）
- 合成配方、村民交易（工具匠）、熔炉燃料（能源石）、自定义创造标签页
- 世界结构与战利品：水晶星球（末地）与 malikaidao_grave（主世界）
